...
export class MainComponent implements OnInit {
   ...
   constructor(private loader: LoadingBarService,
      ...
      title.setTitle('Undely - Angular Material Design eCommerce Template');
      ...
      meta.addTags([
         ...
         { name: 'description', content: 'Undely is an E-Commerce angular 7 based template with material design. It also comes with Angular cli. Now you have all the power to maintain your ecommerce site. Responsive design gives your user to use in any modern devices. Clean Code gives you the power to customize the code as per as your requirments. Undely has all the basics functionality which is required in ecommerce site. Rtl design makes the multi-language support with more easy way.' }
      ]);

      if (this.undelyService.isDirectionRtl) {
         this.isRtl = 'rtl';
      } else {
         this.isRtl = 'ltr';
      }
   ...
   public hideSideNav() {
      this.undelyService.sidenavOpen = false;
   }

   public changeDirection() {
      if (this.isRtl == 'rtl') {
         this.isRtl = 'ltr';
         this.undelyService.isDirectionRtl = false;
      } else {
         this.isRtl = 'rtl'
         this.undelyService.isDirectionRtl = true;
      }
